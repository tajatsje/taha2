			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/Xx_Taha_xX1",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @Xxx_KSOMK_xxX💙',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
                       [['text'=>"𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧", 'url'=>"https://t.me/Xxx_Ksomk_xxX"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/Xxx_Ksomk_xxX"]],
                       ]
                       ])
                       ]);
...
𝘾𝙤𝙣𝙩𝙖𝙘𝙩 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 - @Xxx_Ksomk_xxX",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
...
اضغط في الاسفل لمراسله المطور 👇",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧','url'=>'t.me/Xxx_Ksomk_xxX']]
                  ]
							])
					]);
				}
